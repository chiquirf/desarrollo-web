...
* *The clearfix Hack* >> no es necesario poner un div vacio al final con clear:both; solo poner al contenedor: conteneodr{overflow: auto;}
* *The clearfix Hack 2* >> aplicar al contenedor esto: contenedor:after {content: ""; clear: both; display: block;}
...
* SELECTORES: [CSS Selector Reference](http://www.w3schools.com/cssref/css_selectors.asp)
  - Clases: *.nombre-clase {...}*
  - Id: *#id-elemento {...}*
  - Elemento: *elemento {...}*
...
* CSS3 box Shadow Effects (IE>=9 +prefix)
